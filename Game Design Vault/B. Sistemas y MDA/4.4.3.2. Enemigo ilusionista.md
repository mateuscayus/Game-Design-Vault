...
Si el jugador realiza exitosamente la [[4.2.3.1. M. de Parry]] a un enemigo ilusionista, no lo aturdirá ([[4.2.8. M. de Stun]]), a diferencia de lo que ocurre con el [[4.4.3.1. Enemigo melee]].
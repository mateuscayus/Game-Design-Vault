...
La transformación del jugador no es instantánea ni completa, sino que se desarrolla gradualmente a medida que encadena ataques ([[4.2.4. M. de Racha]]). Al alcanzar un número determinado de ataques en la racha, la transformación progresará.
...
==Mantener la racha es fundamental== para alcanzar la máxima forma bestial. Sin embargo, si el jugador pierde la racha, su progreso se reiniciará y volverá a su forma humana, quedando en un estado de alta vulnerabilidad. El ==único factor que provoca la pérdida de la racha es que el cooldown del encadenamiento llegue a 0==. Los ataques enemigos, incluso si impactan al jugador, no interrumpen la racha, si bien complican encadenar el siguiente ataque. 
...
Para profundizar en los aspectos técnicos del Bloody Combo, revisar: [[4.2.5. M. de Progresión del Bloody Combo (mutaciones)]].